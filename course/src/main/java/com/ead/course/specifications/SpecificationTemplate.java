...
public class SpecificationTemplate {
    ...
    public static Specification<ModuleModel> moduleCourseId(final UUID courseId) {
        return (root, query, cb) -> {
            ...
            return cb.and(cb.equal(course.get("courseId"), courseId), cb.isMember(module, courseModules)); // CriteriaBuilder usando AND -> courseId igual ao recebido E membro de courseModules
        };
    }
